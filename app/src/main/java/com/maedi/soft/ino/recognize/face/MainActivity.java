...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            new Thread(() -> {
                try {
                    isFaceEmpty = recognizer.updateData(requestCode, getContentResolver(), uris);
                } catch (Exception e) {
                ...
                runOnUiThread(() -> {
                    ...
                    if(isFaceEmpty)Toast.makeText(f, "No face detected!", Toast.LENGTH_SHORT).show();
    ...
    private boolean isFaceEmpty = true;
